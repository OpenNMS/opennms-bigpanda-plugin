...
package org.opennms.integrations.bigpanda.shell;
...
import org.opennms.integrations.bigpanda.TopologyForwarder;
import org.opennms.integrations.bigpanda.model.Topology;

@Command(scope = "opennms-bigpanda", name = "push-topology", description = "Push the topology")
@Service
